...
```
# 2025 annual data entry is complete. {style="text-align: center;"}
# Check back in 2026! {style="text-align: center;"}
...
We are `r perdonefw`% done with fieldwork, and `r perdone`% done with entry. We haven't missed any units yet.
