...
```{r, fig.cap="Figure 3_23. Size frequency distributions of all corals observed by each diver in 2023."}
chs_corals_23 %>% 
   ggplot(data=.) + 
   geom_histogram(aes(x=`Length cm`), binwidth=10) + 
...
```{r, fig.cap="Figure 3_24. Size frequency distributions of all corals observed by each diver in 2024PBL."}
chs_corals_24 %>% 
   ggplot(data=.) + 
   geom_histogram(aes(x=`Length cm`), binwidth=10) + 
   facet_wrap(~Name, scales = "free_y")
