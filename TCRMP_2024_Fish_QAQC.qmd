...
fts_raw <- read_csv("data/2024/FishTransects_all_2025-02-05.csv") %>% 
   mutate(Total = rowSums(select(.,X0to5:Xgt150), na.rm=T))
frs_raw <- read_csv("data/2024/FishRovers_all_2025-02-05.csv")
das_raw <- read_csv("data/2024/Diadema_all_2025-02-05.csv")
